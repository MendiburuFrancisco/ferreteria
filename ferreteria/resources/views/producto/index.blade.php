...
<section class="">
    ...
    <div class="container">
        ...
        <div class="row justify-content-left row-cols-2 row-cols-md-3 row-cols-xl-2">
            ...
            <div class="col mb-1"  style="height: 375px; width:270px;">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            ...
                            <h5 style="font-size:18px">
                                <a href="{{url('producto/show/'.$producto->codigo)}}">{{$producto->nombre}}</a></h5>
                            <!-- Product reviews-->
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        ...
                        <div class="text-center">
                            ...
                            <a class="btn btn-outline-dark mt-auto"  href="{{url('producto/edit/'.$producto->codigo)}}">Agregar al carrito</a>
                        </div>
                    </div>
                </div>
            </div>
